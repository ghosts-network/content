...
namespace GhostNetwork.Content.Api.Controllers
{
    ...
    public class CommentsController : ControllerBase
    {
        ...
        public async Task<ActionResult<Comment>> UpdateAsync([FromRoute] string commentId, [FromBody][Required] UpdateCommentModel comment)
        {
            ...
            var domainResult = await commentService.UpdateAsync(commentId, comment.Content);
